        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-6">
          {stats.map((stat, i) => (
            <motion.div
              ...
              className={`group relative p-8 rounded-2xl bg-gradient-to-br ${stat.gradient} border ${stat.border} hover:shadow-[0_0_40px_rgba(6,182,212,0.15)] transition-all duration-500`}
            >
              <div
                className={`w-14 h-14 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center mb-5 group-hover:scale-110 transition-transform duration-300`}
              >
