...
export default function TradingInfographic() {
  return (
    <motion.div
      ...
      className="relative w-full bg-[#0a0f24]"
      style={{ backgroundColor: "#0a0f24" }}
    >
      <div className="relative rounded-2xl border border-cyan-500/20 bg-[#0a0f24] shadow-[0_0_60px_rgba(6,182,212,0.15)] overflow-hidden">
        <div className="flex items-center justify-between px-5 py-3 border-b border-cyan-500/10 bg-[#061024]">
        ...
        <div className="p-5 space-y-4">
          <div className="grid grid-cols-3 gap-3">
            {metrics.map((m) => (
              <motion.div
                key={m.label}
                className="rounded-xl border border-cyan-500/10 bg-[#061024] p-3 text-center"
              >
                <div
          ...
          <div className="grid grid-cols-1 sm:grid-cols-[1fr_auto] gap-4">
            <motion.div className="rounded-xl border border-cyan-500/10 bg-[#040816] p-4">
            ...
            <div className="flex flex-col gap-3 min-w-[120px]">
              ...
              <div className="rounded-xl border border-cyan-500/10 bg-[#061024] p-3 space-y-2">
                ...
                {aiSignals.map((s, i) => (
                  ...
                  >
                    ...
                    <span className={`font-semibold shrink-0 ${s.color}`}>
                      {s.conf}
                    </span>
                  </motion.div>
                ))}
          ...
          <div className="rounded-xl border border-cyan-500/10 bg-gradient-to-r from-cyan-500/10 via-[#061024] to-violet-500/10 p-3">
            <div className="flex flex-wrap items-center justify-between gap-2 text-[11px]">
              ...
              <span className="text-cyan-400/80 text-[10px] ml-auto">
                Powered by AI
              </span>
            </div>
          </div>
      ...
      <div className="absolute -bottom-4 -left-4 hidden sm:flex px-4 py-3 rounded-xl border border-cyan-500/20 bg-[#0a0f24] shadow-lg">
        <div className="flex items-center gap-2">
      ...
      <div className="absolute -top-3 -right-3 px-4 py-3 rounded-xl border border-blue-500/20 bg-[#0a0f24] shadow-lg">
