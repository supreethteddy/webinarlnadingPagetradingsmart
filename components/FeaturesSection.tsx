...
import { BarChart3, Workflow, Shield, Link2, Gamepad2, BrainCircuit } from 'lucide-react';
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">
              Six core pillars designed to transform how you approach the markets with artificial intelligence.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((f, i) => (
              <motion.div
                ...
                className="group relative p-7 rounded-2xl bg-white/[0.02] backdrop-blur-xl border border-white/[0.06] hover:border-cyan-500/30 hover:shadow-[0_0_40px_rgba(6,182,212,0.1)] transition-all duration-500"
              >
